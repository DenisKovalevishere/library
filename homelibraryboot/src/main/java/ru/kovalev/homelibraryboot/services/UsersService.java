...
public class UsersService {
	...
	public UsersService(InformationsBookPersonRepository informationsBookPersonRepository,
			BooksRepository booksRepository, PeopleRepository peopleRepository, LibrarianServise librarianServise) {
	...
	public List<InformationBookPerson> findMyInformation() {
		return informationsBookPersonRepository.findByRidingPerson(librarianServise.getCurrentPerson()).stream()
				.sorted((o1, o2) -> ((o1.getReadBook().getTitle().compareTo(o2.getReadBook().getTitle()))))
